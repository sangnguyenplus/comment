    ...
    <div class="bb-comment-box d-flex">
        ...
        <form class="bb-textarea" @submit="this.postComment">
            <textarea
                ...
                rows="1"
                name="comment"
                :placeholder="__('Share your thoughts about that')"
                @change="onChange"
                :value="value"
            />
            ...
            <div class="bb-textarea-footer">
                <div class="bb-textarea-footer-left"></div>
                ...
                <div class="bb-textarea-footer-right" v-if="!isEdit">
                    <button
                        ...
                        v-if="data.userData"
                        :class="
                            'post-btn' + (isSending ? ' button-loading' : '')
                        "
                    >
                        {{ __("Post as") }} {{ data.userData.name }}
                    </button>
                    <button
                        type="submit"
                        v-if="!data.userData"
    ...
    methods: {
        ...
        postComment(e) {
            ...
            if (!this.data.userData) {
                ...
                Http.post(this.postUrl, formData).then(
                    ({ data }) => {
